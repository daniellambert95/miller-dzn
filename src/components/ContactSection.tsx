            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <a href="mailto:info@millerdesign.com" className="text-gray-700 hover:color-primary-direct">
                    info@millerdesign.com
                  </a>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <a href="tel:+12345678900" className="text-gray-700 hover:color-primary-direct">
                    +1 (234) 567-8900
                  </a>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 hover:bg-primary hover:text-white transition-colors p-2 rounded-full">
