      ...
      <div className="container-custom flex justify-between items-center py-4">
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center">
            {/* Use white logo only on home page when not scrolled and menu closed */}
        ...
        <div className="flex items-center gap-4 mr-8">
          <a href="https://www.instagram.com/millerdesign__/" target="_blank" className={`${!isHomePage || isScrolled || isMenuOpen ? 'text-secondary' : 'text-white'} hover:text-primary transition-colors`} aria-label="Instagram">
          ...
          <a href="https://www.tiktok.com/@millerdzn" target="_blank" className={`${!isHomePage || isScrolled || isMenuOpen ? 'text-secondary' : 'text-white'} hover:text-primary transition-colors`} aria-label="TikTok">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          className={`${!isHomePage || isMenuOpen || isScrolled ? 'text-secondary' : 'text-white'}`}
